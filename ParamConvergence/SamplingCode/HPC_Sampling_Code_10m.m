...
%% This 10m sampling code additionally labels the virtual patients to save only the TAD and INT ones, because
%% we don't need PAD and NAD patients since they already converged in smaller sampling
...
output_filename = 'simulation_results_10m.mat';
